...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Filters -->
    <form method="GET" action="{{ route('admin.audit-logs') }}" class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="{{ route('admin.audit-logs') }}" class="w-full px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl font-semibold text-sm text-center">Clear</a>
            </div>
        </div>
    </form>
